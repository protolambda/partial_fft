...
def partial_fft(evens: list, odds: list, a: list, modulus: int, domain: list, inverse_domain: list) -> (list, list):
    ...
    b = [0] * half
    odds0, L1 = partial_fft(evens[::2], evens[1::2], L0, modulus, domain[::2], inverse_domain[::2])
    odds1, R1 = partial_fft(odds[::2], odds[1::2], R0, modulus, domain[::2], inverse_domain[::2])
...
def partial_fft_test(half_values, domain, even_coeffs):
    ...
    resolved_odd_values, resolved_odd_coeffs = partial_fft(half_full_values[::2], half_full_values[1::2], even_coeffs, modulus, domain, inverse_domain)
